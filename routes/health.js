...
router.get('/list/article/:id',Middlewares.get_articles_category,Requests.get_article_list,Requests.get_article_list_diseases,Requests.get_article_list_ask,Requests.get_article_detail,Handlers.get_article);
