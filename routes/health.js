...
/* GET users listing. */
router.get('/',Middlewares.get_articles_category,Requests.get_article_list_diseases,Requests.get_article_list_ask,Requests.get_article_list,Handlers.get_article_list);

//科普详情
router.get('/article/:id.html',
...
//前端分页获取问答数据
router.post('/list_ask_web',Middlewares.get_articles_category,Requests.get_list_ask_web)
