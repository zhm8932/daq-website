...
define(function (require, exports, module) {
    ...
    Popup.prototype = {
        ...
        popupHtml: function () {
            var opts = this.opts;
            var ConfimHtml = '<div class="' + this.popupBox + ' ' + this.opts.otherBox + '" style="width: ' + opts.width + 'px;margin-left:-' + opts.width / 2 + 'px"><span class="' + this.opts.cancel + '">关闭</span><article>' + this.opts.msg + '</article>' +
