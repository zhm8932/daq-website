...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, module) {
	    ...
	    function addTr() {
	        var trHtml = '<tr class="new-tr"><td class="name"><input placeholder="就诊人姓名"/></td>' + '<td class="gender"><div class="select-box"><div class="selected"><span class="text">请选择</span><i class="icon pull-down"></i></div><ul class="options"><li class="option">男</li><li class="option">女</li></ul></div></td>' + '<td class="birthday"><input placeholder="出生年月"/></td>' + '<td class="telephone"><input placeholder="联系电话"/></td>' + '<td class="new-patient"><a class="text-main" href="javascript:void(0)">添加</a></td></tr>';
	        var tr = $(trHtml);
