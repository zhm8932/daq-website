	                ...
	                success: function (result) {
	                    ...
	                    if (json.success) {
	                        ...
	                        $.each(data, function (index, arr) {
	                            ...
	                            html += '<li class="box"><a href="/screenings/goods/detail/' + arr.id + '"><img data-original="' + imgUrl + '"/><h4><a href="/screenings/goods/detail/' + arr.id + '">' + arr.goodsName + '</a></h4><p>' + arr.fitPeople + '</p>' + '<div class="price"><span class="new"><em>￥</em>' + discountPrice + '</span><span class="old">原价' + price + '</span></div></div></li>';
	                        });
