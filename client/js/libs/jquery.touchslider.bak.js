...
(function (factory) {
	...
	window.touchSlider = function(options) {
		...
		// 		viewportWidth = viewport.parent().width()
		// 	}}
		// })
		...
		if (scroller.css("position") !== "absolute") {
			...
			$(window).resize(function () {
				if(options.bResize){
					viewportHeight = viewport.children().children().height();
					// viewportWidth = viewport.children().children().width()
					viewportWidth = $(window).width();

					console.log("viewportHeight-图片大小:",viewportHeight)
					console.log("viewportWidth-图片大小:",viewportWidth)
